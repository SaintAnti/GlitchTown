...
class ApplicationMain {
	...
	public static function create ():Void {
		...
		urls.push ("assets/data/grid.csv");
		types.push (lime.Assets.AssetType.TEXT);
		
		
		urls.push ("assets/data/grid.tmx");
		types.push (lime.Assets.AssetType.TEXT);
		
		
		urls.push ("assets/data/grid.txt");
		types.push (lime.Assets.AssetType.TEXT);
		
		
		urls.push ("assets/data/grid2.csv");
		types.push (lime.Assets.AssetType.TEXT);
		...
		urls.push ("assets/images/grid.psd");
