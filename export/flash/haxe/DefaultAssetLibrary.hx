...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("assets/data/grid.csv", __ASSET__assets_data_grid_csv);
		type.set ("assets/data/grid.csv", AssetType.TEXT);
		className.set ("assets/data/grid.tmx", __ASSET__assets_data_grid_tmx);
		type.set ("assets/data/grid.tmx", AssetType.TEXT);
		className.set ("assets/data/grid.txt", __ASSET__assets_data_grid_txt);
		type.set ("assets/data/grid.txt", AssetType.TEXT);
		className.set ("assets/data/grid2.csv", __ASSET__assets_data_grid2_csv);
		type.set ("assets/data/grid2.csv", AssetType.TEXT);
		className.set ("assets/images/grid.png", __ASSET__assets_images_grid_png);
		type.set ("assets/images/grid.png", AssetType.IMAGE);
		className.set ("assets/images/grid.psd", __ASSET__assets_images_grid_psd);
		type.set ("assets/images/grid.psd", AssetType.BINARY);
		...
		id = "assets/data/grid.csv";
		path.set (id, id);
		
		type.set (id, AssetType.TEXT);
		id = "assets/data/grid.tmx";
		path.set (id, id);
		
		type.set (id, AssetType.TEXT);
		id = "assets/data/grid.txt";
		path.set (id, id);
		
		type.set (id, AssetType.TEXT);
		id = "assets/data/grid2.csv";
		path.set (id, id);
...
@:keep @:bind #if display private #end class __ASSET__assets_data_grid_csv extends flash.utils.ByteArray { }
@:keep @:bind #if display private #end class __ASSET__assets_data_grid_tmx extends flash.utils.ByteArray { }
@:keep @:bind #if display private #end class __ASSET__assets_data_grid_txt extends flash.utils.ByteArray { }
@:keep @:bind #if display private #end class __ASSET__assets_data_grid2_csv extends flash.utils.ByteArray { }
...
@:keep @:bind #if display private #end class __ASSET__assets_images_grid_psd extends flash.utils.ByteArray { }
...
@:file("assets/data/grid.csv") #if display private #end class __ASSET__assets_data_grid_csv extends lime.utils.ByteArray {}
@:file("assets/data/grid.tmx") #if display private #end class __ASSET__assets_data_grid_tmx extends lime.utils.ByteArray {}
@:file("assets/data/grid.txt") #if display private #end class __ASSET__assets_data_grid_txt extends lime.utils.ByteArray {}
@:file("assets/data/grid2.csv") #if display private #end class __ASSET__assets_data_grid2_csv extends lime.utils.ByteArray {}
@:image("assets/images/grid.png") #if display private #end class __ASSET__assets_images_grid_png extends lime.graphics.Image {}
@:file("assets/images/grid.psd") #if display private #end class __ASSET__assets_images_grid_psd extends lime.utils.ByteArray {}
